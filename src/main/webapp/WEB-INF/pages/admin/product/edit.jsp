...
<center>
    ...
    <div id="container">
        <h3>Product info</h3>
        <form:form method = "POST" action = "/shop-app/editProduct" id="productForm">
            <table>
                <tr>
                ...
                <tr>
                    <td><form:label path = "numberAvailable">Number Available</form:label></td>
                    <td><form:input path = "numberAvailable" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Category</td>
                    <td>
                        <select form="productForm" name="categoryId">
