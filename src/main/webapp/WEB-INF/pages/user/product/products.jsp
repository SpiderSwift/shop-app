...
<center>
    ...
    <div id="container">
        <table>
            ...
            <tr><th>Id</th><th>Name</th><th>Description</th><th>Available</th><th>Category</th><th>Price</th><th>Number</th><th>Add</th></tr>
            <c:forEach items="${listProducts}" var="product">
                <tr>
                    ...
                    <form method="get" action="/shop-app/user/product/addToCart"><td><input type="number" name="number" min="1" max="${product.numberAvailable}" /></td>
                        <td><button class="button" type="submit" value="${product.productId}" name="productId" >add</button></td></form>
                </tr>
            </c:forEach>
...
<%--<c:forEach items="${listProducts}" var="product">--%>
    <%--<tr>--%>
        ...
        <%--<form method="get" action="/shop-app/user/product/addToCart"><td><input type="number" name="number" min="1" max="${product.numberAvailable}" /></td>--%>
            <%--<td><button type="submit" value="${product.productId}" name="productId" >add</button></td>></form>--%>
    <%--</tr>--%>
<%--</c:forEach>--%>