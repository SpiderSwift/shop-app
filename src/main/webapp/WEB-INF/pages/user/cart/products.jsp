...
<center>
    ...
    <div id="container">
        <table>
            <tbody>
            <tr><th>Id</th><th>Name</th><th>Description</th><th>Number</th><th>Category</th><th>Price</th><th>Remove</th></tr>
            <c:forEach items="${cart.cartProducts}" var="product">
                <tr>
                    <td><c:out value="${product.product.productId}" /></td>
                    <td><c:out value="${product.product.name}" /></td>
                    <td><c:out value="${product.product.description}" /></td>
                    <td><c:out value="${product.number}" /></td>
                    <td><c:out value="${product.product.category}" /></td>
                    <td><c:out value="${product.product.price}" /></td>
                    <td><form method="get" action="/shop-app/user/cart/delete/${product.product.productId}"><button class="button" type="submit" >Remove</button></form></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <form method="get" action="/shop-app/user/cart/order"><button class="button" type="submit">Buy</button></form>
    </div>
</center>
